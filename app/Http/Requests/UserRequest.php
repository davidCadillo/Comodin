...
class UserRequest extends FormRequest {
        ...
        switch ($this->method()) {
            ...
            case 'PATCH':
                return [
                    ...
                    'apellido1' => 'sometimes|required|alpha|max:25',
                    'apellido2' => 'sometimes|required|alpha|max:25',
                    'password'  => 'sometimes|required|between:8,17',
                    'dni'       => 'unique:users,dni|digits:8',
                    'celular'   => 'unique:users,phone|digits:9',
                    'email'     => 'sometimes|required|email|unique:users,email',
                    'fecha_nac' => 'sometimes|required|date_format:d/m/Y',
                ];
            default:
                break;
        }
    ...
    public function messages() {
        return [
            ...
            'fecha_nac.required' => 'La fecha de nacimiento no puede qquedar en blanco',
        ];
